...
const Content = ({ post }: Props) => {
  ...
  /**
   * Async function that generates AI content and sets it to the editor.
   * @returns {Promise<void>} Promise that resolves when AI content is generated and set to the editor.
   */
  const postAiContent = async (): Promise<void> => {
    /**
     * Sets the content of the editor to "Generating Ai Content. Please Wait...".
     * @throws {Error} Throws an error if the editor cannot be focused.
     */
    editor
      .chain()
      .focus()
  ...
  return (
    <div className="w-full max-w-full mb-10">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* MARK: AI GENERATOR */}
        {isEditable && (
          <div className="p-3 mb-4 border-2 rounded-md bg-background text-foreground">
            ...
            <div className="flex justify-between gap-5">
              <Input
                ...
                value={role}
              />
              <Button onClick={postAiContent}>
                <Rocket className="mr-2" /> Generate
              </Button>
            </div>
          </div>
        )}
